...
// 博雅地名网
const tcmapUrl = 'http://www.tcmap.com.cn';
const writeJSON = fs.createWriteStream('code-share/zoning-data/tcmap/data/list.json', {
    flags: 'w',
...
const errorlog = fs.createWriteStream('code-share/zoning-data/tcmap/data/error.log', {
    flags: 'w',
    defaultEncoding: 'utf-8',
    fd: null,
    mode: 0o666,
